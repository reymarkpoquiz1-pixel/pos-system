                        ...
                        children: [
                          ...
                          InventoryView(
                            ...
                            onRefresh: _fetchAllData,
                                ...
                                const PromosView(),
                                const VouchersView(),
                                PaymentsView(transactions: _transactionsList, isMobile: isMobile),
                                const SuppliersView(),
                                const ExpensesView(),
                                const ReportsView(),
                                const AuditLogsView(),
                                ShiftManagementView(userId: widget.userId),
                                const ReviewsManagementView(),
                                SettingsView(onUpdate: _fetchAllData, userId: widget.userId),
                              ],
                            ),
                    ),
                  ],
